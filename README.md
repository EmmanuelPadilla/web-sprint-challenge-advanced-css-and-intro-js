...
+++++++++++ Accesability is like describing your web page to someone with visual impairments. they can't ++++++++++++++see pictures, so you have to add alternate descriptions to pictures, make fonts scaleable, +++++++++++++++++colors, etc
2. Talk about 3 different things you can do to ensure your website is accessible. 
++++++++  make sure text is scaleable, your html is semantic (describe sections) make sure your images and +++++++++++ links have alt tags
3. How would you explain the concept of a variable to someone new to programming?
+++++A variable can be an object that contains an assignable value, but is subject to change.
4. What is the purpose of using functions in code?
+++++++functions in code allow us to invoque code-blocks in single words, with out re-typing the whole code
